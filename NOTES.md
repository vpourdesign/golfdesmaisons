...
- [2026-05-19] **Lexus Laval confirme participation** : commandite d'un trou avec drapeaux Lexus (500 $) + droits d'accès et de jeu pour un quatuor — confirmé par Natalia Rotaru
- [2026-05-15] Problème de « booking » sur le concours du « trou d'un coup » — réservé par un autre concessionnaire avant Lexus. Alexandre a proposé alternatives ; Lexus a choisi commandite trou + quatuor

## 🔍 Précisions

- Contacts complets (organisateurs + commanditaires) dans [`CONTACTS.md`](CONTACTS.md)
- **Commandite Lexus Laval confirmée** : trou avec drapeaux Lexus (500 $) + droits quatuor
- **Logos Lexus vectoriels reçus** le 2026-05-25 (envoyés par Vanessa Cefaloni — Dilawri Marketing)
